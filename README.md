...
2. Devreyi çalıştırabilmek için Proteus üzerindeki Ardunio devresine sağ tıklayıp Edip Component'e basmanız gerekli.
...
Girmek istediğiniz banknot sayısını tuşlayın ve bitiş butonuna basarak kasadaki toplam para miktarını görebilirsiniz.
...
Seçilen işlem sonucunda kalan hizmet adedi ve yapılan işlemin ücreti lcd ekran üzerinde gösterilir.
